export class SharedConstants {
    public static readonly EVENT_PLAYER_MOVED = 'event_player_moved';
    public static readonly EVENT_PLAYER_UPDATE = 'event_player_update';
    public static readonly EVENT_PLAYER_JOINED = 'event_player_joined';
